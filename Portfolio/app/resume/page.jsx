...
const about = {
    ...
    info : [
        { fieldName : "Name", fieldValue : "Tanvir Hasan Abir" },
        { fieldName : "Phone", fieldValue : "+880 1816573159" },
        { fieldName : "Experience", fieldValue : "1+ years" },
        { fieldName : "Email", fieldValue : "bss1321@iit.du.ac.bd" },
...
const experience = {
    ...
    items : [
        { company : "IIT Software Engineers' Community (IITSEC)", position : "Organizing Secretary", duration : "2024 - Present" },
        { company : "Govt. Science College Science Club (GSCSC)", position : "General Member", duration : "2018 - 2020" }
    ]
}
...
const education = {
    ...
    title : "Education",
    description : "I am completing my Bachelor of Science in Software Engineering from University of Dhaka.",
    items : [
        { institution : "University of Dhaka", degree : "Bachelor of Science in Software Engineering", duration : "2020 - Present" },
        { institution : "Govt. Science College", degree : "Higher Secondary Certificate", duration : "2018 - 2020", result : "GPA : 5.00/5.00" }
    ]
}
    ...
    return (
        ...
        className="min-h-[80vh] flex items-center justify-center py-12 xl:py-0">
            <div className="container mx-auto">
                <Tabs defaultValue="Experience" className="flex flex-col xl:flex-row gap-6 xl:gap-[60px]">
                    ...
                    <div className="min-h-[70vh] w-full">
                                ...
                                <ScrollArea className="h-[400px]">
                                    <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                                        {experience.items.map((item, index) => {
                                            return (
                                                <li key={index} className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col items-center justify-center lg:items-start gap-2">
                                ...
                                <ScrollArea className="h-[400px]">
                                    <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                                        {education.items.map((item, index) => (
                                            <li key={index} className="bg-[#232329] py-6 px-10 rounded-xl flex flex-col items-center justify-center lg:items-start gap-3">
                                                <span className="text-accent">{item.duration}</span>
                        ...
                        <TabsContent value="Skills" className="w-full h-full">
                            <div className="flex flex-col gap-6">
                                {/* Languages Section */}
                                <div className="flex flex-col gap-6 text-center xl:text-left">
                                    <h3 className="text-3xl md:text-4xl font-bold">{skills.languages.title}</h3>
                                    <p className="max-w-[600px] mx-auto xl:mx-0 text-white/60">{skills.languages.description}</p>
                                </div>
                                ...
                                {/* Tools Section */}
                                <div className="flex flex-col gap-6 text-center xl:text-left mt-10">
                                    <h3 className="text-3xl md:text-4xl font-bold">{skills.tools.title}</h3>
                                    <p className="max-w-[600px] mx-auto xl:mx-0 text-white/60">{skills.tools.description}</p>
                                </div>
                                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 xl:gap-[30px]">
                                ...
                                <div className="flex flex-col gap-6 text-center xl:text-left mt-10">
                                    <h3 className="text-3xl md:text-4xl font-bold">{skills.librariesAndFrameworks.title}</h3>
                                    <p className="max-w-[600px] mx-auto xl:mx-0 text-white/60">{skills.librariesAndFrameworks.description}</p>
                                </div>
                                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 xl:gap-[30px]">
