        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-6 xl:pb-20">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I'm <br/><span className="text-accent">Tanvir Hasan Abir</span>
            </h1> 

            <p className="max-w-[500px] mb-9 text-white/80">
              I excel at crafting elegant digital experiences and I am proficient in various programming languages and frameworks.
            </p>

            {/* Button */}
            <div className="flex flex-col xl:flex-row items-center gap-8">
              <a href="./Abir Resume_Final.pdf" download className="inline-flex items-center gap-2">
